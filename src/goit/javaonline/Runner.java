...
//назавание методов - нужен глагол

//убери кириллицу что-ли

//Зачем создавать обьекты круг, дистанция и температура? Почему не сделать методы статическими?

//squareTringle - mistake